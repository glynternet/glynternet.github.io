...
{
	if (region.aw.Z === region.aH.Z)
	{
		return 'on line ' + region.aw.Z;
	}
	return 'on lines ' + region.aw.Z + ' through ' + region.aH.Z;
}
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{l: nodeList, f: (len / $elm$core$Array$branchFactor) | 0, i: tail});
			} else {
																...
																return function (itemSpacing) {
																	return function (distanceDetail) {
																		return function (showStartFinish) {
																			return {B: activeTab, m: categoryFilterEnabled, j: distanceDetail, k: filteredCategories, x: fontSize, r: intensityTau, e: itemSpacing, s: manualPosition, u: referencePoint, p: showIntensity, K: showOptions, o: showStartFinish, q: splits, h: totalDistanceDisplay, y: trackHeight, z: trackThickness, E: trackingIntervalSec, b: tracks, A: waypointStrokeColor};
																		};
																	};
																};
															};
...
var $author$project$Main$defaultStoredState = $author$project$Main$StoredState($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing)($elm$core$Maybe$Nothing);
...
var $author$project$GpxApi$Track = F2(
	function (trackpoints, waypoints) {
		return {bI: trackpoints, bL: waypoints};
	});
var $author$project$GpxApi$TrackPoint = F4(
	function (distance, elevation, lat, lon) {
		return {aF: distance, bj: elevation, bq: lat, br: lon};
	});
...
var $author$project$GpxApi$Waypoint = F5(
	function (distance, name, categories, gain, loss) {
		return {be: categories, aF: distance, bl: gain, bs: loss, bx: name};
	});
			...
			A2(
				...
				A2(
					...
					A2(
						$author$project$Main$andMap,
						$elm$json$Json$Decode$maybe(
							A2($elm$json$Json$Decode$field, 'splits', $elm$json$Json$Decode$int)),
						A2(
							$author$project$Main$andMap,
							$elm$json$Json$Decode$maybe(
...
var $author$project$Main$defaultCuesheetOptions = {j: $author$project$Main$defaultDistanceDetail, e: $author$project$Main$defaultSpacing, bC: 0, u: 1000, o: false, h: $author$project$Main$FromZero};
var $author$project$Main$defaultElevationProfileOptions = {x: 15, r: 500, s: $elm$core$Maybe$Nothing, p: false, q: 1, y: 200, z: 1, A: 'lightgray'};
...
var $author$project$Main$storedStateModel = function (state) {
	return {
		...
		c: {
			j: A2($elm$core$Maybe$withDefault, $author$project$Main$defaultCuesheetOptions.j, state.j),
			e: A2($elm$core$Maybe$withDefault, $author$project$Main$defaultCuesheetOptions.e, state.e),
			bC: 0,
			u: A2($elm$core$Maybe$withDefault, $author$project$Main$defaultCuesheetOptions.u, state.u),
			o: A2($elm$core$Maybe$withDefault, $author$project$Main$defaultCuesheetOptions.o, state.o),
			h: A2(
				$elm$core$Maybe$withDefault,
				$author$project$Main$defaultCuesheetOptions.h,
				A2($elm$core$Maybe$andThen, $author$project$Main$parseTotalDistanceDisplay, state.h))
		},
		a: {
			...
			s: state.s,
			p: A2($elm$core$Maybe$withDefault, $author$project$Main$defaultElevationProfileOptions.p, state.p),
		...
		k: A2($elm$core$Maybe$withDefault, $elm$core$Dict$empty, state.k),
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				model.N ? A2($elm$time$Time$every, model.E * 1000, $author$project$Main$Tick) : $elm$core$Platform$Sub$none,
...
var $author$project$Location$LocationState = F3(
	function (position, accuracy, matchedDistance) {
		return {aB: accuracy, bu: matchedDistance, bC: position};
	});
...
var $author$project$Main$correctWaypointSelectionInModel = function (model) {
	...
	if (_v0.$ === 1) {
		...
		var tracks = _v0.a;
		var cs = model.c;
		var allWaypoints = tracks.d.bL;
		var filtered = A3($author$project$Main$filterWaypointsByCategory, model.m, model.k, allWaypoints);
...
var $author$project$Main$trackUpdateWaypoint = F3(
	function (track, i, updateWaypoint) {
		return A2(
			...
			track,
			A3($elm_community$list_extra$List$Extra$updateAt, i, updateWaypoint, track.bL));
	});
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					_Utils_Tuple2(
					'gain',
					$elm$json$Json$Encode$float(waypoint.bl)),
					_Utils_Tuple2(
					'loss',
					$elm$json$Json$Encode$float(waypoint.bs))
				]));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'trackpoints',
				$author$project$PositionalTracks$encodeTrackpoints(track.bI)),
				_Utils_Tuple2(
				'waypoints',
				$author$project$PositionalTracks$encodeWaypoints(track.bL))
			]));
};
...
var $author$project$Main$storedStateFromModel = function (model) {
	return {
		...
		j: $elm$core$Maybe$Just(model.c.j),
		k: $elm$core$Maybe$Just(model.k),
		x: $elm$core$Maybe$Just(model.a.x),
		r: $elm$core$Maybe$Just(model.a.r),
		e: $elm$core$Maybe$Just(model.c.e),
		s: model.a.s,
		u: $elm$core$Maybe$Just(model.c.u),
		p: $elm$core$Maybe$Just(model.a.p),
		K: $elm$core$Maybe$Just(model.K),
		o: $elm$core$Maybe$Just(model.c.o),
		q: $elm$core$Maybe$Just(model.a.q),
		h: $elm$core$Maybe$Just(
			$author$project$Main$formatTotalDistanceDisplay(model.c.h)),
	...
	function (msg, model) {
		switch (msg.$) {
						...
						if (_v7.$ === 3) {
							...
							var matchedDist = A2(
								...
								A2(
									...
									A2($author$project$Location$findNearestTrackPoint, gpsPos, tracks.d.bI)));
							var cs = model.c;
							return _Utils_Tuple2(
								_Utils_update(
									model,
			...
			case 14:
				var category = msg.a;
				var enabled = msg.b;
				var newCategories = A3($elm$core$Dict$insert, category, enabled, model.k);
				return $author$project$Main$updateModel(
									...
									A2(
										...
										function (current) {
											return A2(
												$author$project$Main$trackWithWaypoints,
												current,
												A2($elm_community$list_extra$List$Extra$removeAt, i, current.bL));
										},
										tracks))
							}));
				} else {
											...
											function (previous) {
												return _List_fromArray(
													[
														...
														el.aF - previous.aF,
														_Utils_Tuple2(el.bl - previous.bl, el.bs - previous.bs))
													]);
											},
											accum.a))),
								accum.b));
...
var $author$project$Main$cuesheetSvg = F5(
	function (waypoints, cs, finishDist, refPointEle, refWaypoint) {
		...
		var info = A2($author$project$Main$waypointInfos, cs.bC, waypoints);
		var svgHeight = cs.e * $elm$core$List$length(info);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
				...
				[
					...
					_List_fromArray(
						[
							...
							'-40 -10 240 ' + $elm$core$String$fromInt(svgHeight + cs.e))
						]),
					A2(
						...
						F2(
							function (i, item) {
								var translate = $elm$svg$Svg$Attributes$transform(
									'translate(0,' + ($elm$core$String$fromInt(i * cs.e) + ')'));
								if (!item.$) {
									var waypoint = item.a;
									var waypointEle = function () {
										...
										switch (_v3.$) {
											...
											case 0:
												return $elm$core$Maybe$Just(
													A2($author$project$Main$formatEleGainLoss, waypoint.bl, waypoint.bs));
											case 1:
												return A2(
													$elm$core$Maybe$map,
													function (last) {
														return A2($author$project$Main$formatEleGainLoss, last.bl - waypoint.bl, last.bs - waypoint.bs);
													},
													lastWaypoint);
											case 2:
												return $elm$core$Maybe$Just(
													A2($author$project$Main$formatEleGainLoss, refPointEle.a - waypoint.bl, refPointEle.b - waypoint.bs));
											case 3:
												return A2(
													$elm$core$Maybe$map,
													function (rw) {
														return A2($author$project$Main$formatEleGainLoss, rw.bl - waypoint.bl, rw.bs - waypoint.bs);
													},
													refWaypoint);
											default:
												return A2(
													$elm$core$Maybe$map,
													function (rw) {
														return A2($author$project$Main$formatEleGainLoss, waypoint.bl - rw.bl, waypoint.bs - rw.bs);
													},
													refWaypoint);
										}
									}();
									var waypointDistance = function () {
										...
										switch (_v2.$) {
											...
											case 0:
												return $elm$core$Maybe$Just(
													A2($author$project$Main$formatKm, cs.j, waypoint.aF));
											case 1:
												return $elm$core$Maybe$Just(
													A2($author$project$Main$formatKm, cs.j, finishDist - waypoint.aF));
											case 2:
												return $elm$core$Maybe$Just(
													A2($author$project$Main$formatKm, cs.j, cs.u - waypoint.aF));
											case 3:
												return A2(
													$elm$core$Maybe$map,
													function (rw) {
														return A2($author$project$Main$formatKm, cs.j, rw.aF - waypoint.aF);
													},
													refWaypoint);
											default:
												return A2(
													$elm$core$Maybe$map,
													function (rw) {
														return A2($author$project$Main$formatKm, cs.j, waypoint.aF - rw.aF);
													},
													refWaypoint);
										}
									}();
											...
											A2(
												...
												_List_fromArray(
													[
														...
														$elm$core$String$fromInt((cs.e / 2) | 0))
													]),
												_List_fromArray(
													[
									...
									var strokeWidth = '1';
									var arrowTop = '2';
									var arrowHeadTop = $elm$core$String$fromInt(cs.e - 6);
									var arrowBottom = $elm$core$String$fromInt(cs.e - 2);
									return A2(
										$elm$svg$Svg$g,
										_List_fromArray(
											[translate]),
										_List_fromArray(
											[
												...
												_List_fromArray(
													[
														$elm$svg$Svg$text(
														A2($author$project$Main$formatKm, cs.j, dist) + (' ' + A2($author$project$Main$formatEleGainLoss, gain, loss)))
													]))
											]));
								}
							}),
...
var $author$project$Main$getFinishDistance = function (tracks) {
	return A2(
		...
		A2(
			...
			$elm$core$List$head(
				$elm$core$List$reverse(tracks.d.bI))));
};
	...
	function (finishDist, waypoints) {
		...
		var withStart = hasWaypointAtDistance(0) ? waypoints : A2(
			...
			A5(
				...
				0),
			waypoints);
		if (hasWaypointAtDistance(finishDist)) {
			return withStart;
		} else {
			var lastGainLoss = A2(
				$elm$core$Maybe$withDefault,
				...
				A2(
					$elm$core$Maybe$map,
					function (w) {
						return _Utils_Tuple2(w.bl, w.bs);
					},
					$elm$core$List$head(
						$elm$core$List$reverse(waypoints))));
			return _Utils_ap(
	...
	function (model, tracks) {
		...
		var refWaypoint = function () {
			...
			switch (_v1.$) {
				case 3:
					var idx = _v1.a;
					return A2($author$project$Main$lookupWaypointByIndex, idx, tracks.d.bL);
				case 4:
					var idx = _v1.a;
					return A2($author$project$Main$lookupWaypointByIndex, idx, tracks.d.bL);
				default:
		...
		var refPointEle = function () {
			if (!refWaypoint.$) {
				...
				return _Utils_Tuple2(wp.bl, wp.bs);
			} else {
				return A2($author$project$Main$cumulativeGainLossAtDistance, cs.u, tracks.d.bI);
			}
		}();
		var waypointsWithStartFinish = cs.o ? A2($author$project$Main$injectStartFinish, currentFinishDistance, tracks.d.bL) : tracks.d.bL;
		var filteredWaypoints = model.m ? A2($author$project$Main$cuesFilterByCategory, model.k, waypointsWithStartFinish) : waypointsWithStartFinish;
		return A2(
			$elm$html$Html$div,
			_List_Nil,
			_List_fromArray(
														...
														[
															...
															function () {
																...
																return A2(
																	...
																	function (waypoint) {
																		var y = calc.al(
																			A2($author$project$Main$interpolateWaypointElevation, track.bI, waypoint.aF) - 5);
		...
		while (true) {
			if (!trackpoints.b) {
				...
				if (!trackpoints.b.b) {
					...
					return _Utils_eq(only.aF, dist) ? $elm$core$Maybe$Just(only) : $elm$core$Maybe$Nothing;
				} else {
					var a = trackpoints.a;
					var _v1 = trackpoints.b;
					var b = _v1.a;
					var rest = _v1.b;
					if (_Utils_eq(a.aF, dist)) {
						return $elm$core$Maybe$Just(a);
					} else {
						if ((_Utils_cmp(a.aF, dist) < 0) && (_Utils_cmp(b.aF, dist) > -1)) {
							var t = _Utils_eq(b.aF, a.aF) ? 0 : ((dist - a.aF) / (b.aF - a.aF));
							return $elm$core$Maybe$Just(
								{aF: dist, bj: a.bj + (t * (b.bj - a.bj)), bq: a.bq + (t * (b.bq - a.bq)), br: a.br + (t * (b.br - a.br))});
						} else {
							var $temp$dist = dist,
...
var $author$project$Main$extractSegmentTrackpoints = F3(
	function (segStart, segEnd, trackpoints) {
		...
		var pointsInRange = A2(
			$elm$core$List$filter,
			function (tp) {
				return (_Utils_cmp(tp.aF, segStart) > -1) && (_Utils_cmp(tp.aF, segEnd) < 1);
			},
			trackpoints);
		var withStart = function () {
			...
			if (!_v2.a.$) {
				if (!_v2.b.$) {
					var sp = _v2.a.a;
					var first = _v2.b.a;
					return (_Utils_cmp(first.aF, segStart) > 0) ? A2($elm$core$List$cons, sp, pointsInRange) : pointsInRange;
				} else {
					var sp = _v2.a.a;
					var _v3 = _v2.b;
					return _List_fromArray(
		...
		var withStartAndEnd = function () {
			...
			if (!_v0.a.$) {
				if (!_v0.b.$) {
					var ep = _v0.a.a;
					var lastPt = _v0.b.a;
					return (_Utils_cmp(lastPt.aF, segEnd) < 0) ? _Utils_ap(
						withStart,
						_List_fromArray(
							[ep])) : withStart;
				} else {
				...
				function (i) {
					...
					var segWaypoints = A2(
						...
						A2(
							$elm$core$List$filter,
							function (w) {
								return (_Utils_cmp(w.aF, segStart) > -1) && (_Utils_cmp(w.aF, segEnd) < 1);
							},
							track.bL));
					return {
						bI: A2(
		...
		var maxDistance = A2(
			...
			$elm$core$List$maximum(
				A2(
					...
					tracks.d.bI)));
		var filteredWaypoints = A3($author$project$Main$filterWaypointsByCategory, model.m, model.k, tracks.d.bL);
		var ep = model.a;
		var fullIntensity = ep.p ? A2($author$project$Main$computeIntensity, ep.r, tracks.d.bI) : _List_Nil;
		var segmentLength = maxDistance / A2($elm$core$Basics$max, 1, ep.q);
		var profileViews = A2(
			$elm$core$List$indexedMap,
			F2(
				function (i, seg) {
					...
					var segEnd = segStart + segmentLength;
					var segIntensity = A2(
						$elm$core$List$map,
						function (pt) {
							return _Utils_update(
			...
			A2(
				...
				ep.q,
				A2($author$project$GpxApi$Track, tracks.d.bI, filteredWaypoints)));
			...
			A3(
				...
				A2(
					...
					function (_v0) {
						var idx = _v0.a;
						var wp = _v0.b;
						var label = wp.bx + (' (km ' + (A2($author$project$Main$formatKm, 1, wp.aF) + ')'));
						return A3(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								maxDistance)),
							$elm$html$Html$Attributes$value(
							$elm$core$String$fromFloat(cs.bC)),
							$elm$html$Html$Events$onInput(
							A2(
								$elm$core$Basics$composeR,
								$elm$core$String$toFloat,
			...
			_List_fromArray(
				[
					...
					[
						...
						model.N ? 'Stop Tracking' : 'Start Tracking',
										...
										[
											...
											_List_fromArray(
												[
													...
													$elm$html$Html$Attributes$value(waypoint.bx),
													$elm$html$Html$Events$onInput(
